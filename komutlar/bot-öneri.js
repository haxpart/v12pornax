...
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2020`);  
  ...
  var guildID = "775365032573534229"; // Sunucu ID
 
  var channelID = "775638908527575060"; // Kanal ID
  ...
  if (!öneri) {
    ...
    var embed = new Discord.MessageEmbed()
      ...
      .addField("<a:hypequad:775416596457193493> • Öneren Kullanıcı:", message.author.tag, true)
 
      .addField("<a:hypequad:775416596457193493> • Öneren Kullanıcı ID:", message.author.id,true)
 
      .addField("<a:hypequad:775416596457193493> • Önerisi:", öneri)
