...
if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(`<a:bugra81:783239365701926932>**Bu komutu kullanabilmek için** "\`Yönetici\`" **yetkisine sahip olmalısın.**`);
 ...
 if(!kanal) return message.channel.send(`<a:bugra81:783239365701926932>  **Lütfen Bir Kanal Belirt!** \n**__Örnek Kullanım__** : \`${prefix}otorol-ayarla @Rol #Kanal\``)
  ...
  message.channel.send(`╔▬▬▬▬▬▬▬▬Pronax Otorol▬▬▬▬▬▬▬▬▬
║► <a:bugra81:783239365701926932> Otorol Aktif Edildi.
║► <a:bugra81:783239365701926932> **${rol}** Olarak Güncelledim! 
