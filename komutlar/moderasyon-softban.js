  ...
  if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(`<a:bugra40:783239364468932639>  **Bu komutu kullanabilmek için "\`Yönetici\`" yetkisine sahip olmalısın.**`);
